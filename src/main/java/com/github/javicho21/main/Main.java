package com.github.javicho21.main;

import com.github.javicho21.cloudant.Cloudant;
import com.github.javicho21.config.Configuration;
import com.github.javicho21.rabbitmq.RabbitMQ;
...
public class Main {
    ...
    private static final String USAGE =
        ...
        + "directory for .rabbitmq-cloudant";
    ...
    public static void main(String[] args) throws IOException, ParseException,
        ...
        File configFile = new File(".rabbitmq-cloudant");
        ...
        RabbitMQ rabbitMQ = new RabbitMQ.Builder()
            ...
            .build();
        // Build Cloudant
        Cloudant cloudant = new Cloudant.Builder()
            .setAccount(config.get("CLOUDANT_ACCOUNT"))
            .setUsername(config.get("CLOUDANT_USERNAME"))
            .setPassword(config.get("CLOUDANT_PASSWORD"))
            .build();
        rabbitMQ.addObserver(cloudant);
